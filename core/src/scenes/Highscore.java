...
/**
 * \class Highscore
 * \brief Clasa ce va crea meniul de highscore.
 *
...
public class Highscore implements Screen {
    ...
    private HighscoreButtons highscoreButtons;          /**< elementele din meniu*/

    /**
     * \fn public Highscore(GameMain game)
     * \brief Constructor.
     *
    ...
    public Highscore(GameMain game) {
        ...
        background = new Texture("1.Backgrounds/Highscore Background.png");
    ...
    public void render(float delta) {
        ...
        game.getSpriteBatch().setProjectionMatrix(highscoreButtons.getStage().getCamera().combined);
        ///le deseneaza
